...
export async function generateVirtualTryOn({ modelImageBase64, fashionImageBase64, fashionItemName, fashionCategory, textPrompt, userId }) {
    try {
...
export async function generateSimultaneousTryOn({ modelImageBase64, fashionImagesBase64, textPrompt, userId }) {
    try {
        // Test API key first
        try {
            const testResponse = await ai.models.generateContent({
...
export function imageBufferToBase64(buffer, mimeType = "image/jpeg") {
    return buffer.toString("base64");
}
export function base64ToImageBuffer(base64) {
...
export async function generateProgressiveTryOn({ modelImageBase64, fashionImagesBase64, textPrompt, userId }) {
    try {
