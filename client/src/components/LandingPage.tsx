                        ...
                        className={`group relative flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-300 ${
                            activeSection === section.id
                                ...
                                : isDarkMode
                                    ...
                                    : 'bg-gray-900/20 text-gray-700 hover:bg-gray-900/40'
                        }`}
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="text-center max-w-5xl mx-auto">
                        ...
                        <motion.p
                            ...
                            className={`text-xl md:text-2xl mb-12 leading-relaxed max-w-3xl mx-auto font-light ${isDarkMode ? 'text-white/90 drop-shadow-lg' : 'text-gray-600'}`}
                        >
            ...
            <section id="cta" className={`py-32 relative z-10 ${!isDarkMode ? 'bg-gray-50' : ''}`}>
                ...
                <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <Button
                            size="lg"
                            className={`px-16 py-8 text-xl font-medium transition-all duration-300 hover:scale-105 rounded-full ${isDarkMode ? 'bg-primary text-primary-foreground hover:opacity-90 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_50px_rgba(255,255,255,0.4)]' : 'bg-gray-900 text-white hover:bg-gray-800 shadow-xl hover:shadow-2xl'}`}
                            onClick={() => openAuth('register')}
                        >
                            Start Free Trial
                        </Button>
                ...
                >
                    ...
                    <div className="flex flex-col items-center">
                        <motion.svg
                            ...
                            className={`group-hover:text-primary/70 transition-colors ${isDarkMode ? 'text-white/50' : 'text-gray-400'}`}
                        >
                        ...
                        <motion.svg
                            ...
                            width="24" height="12" viewBox="0 0 24 12" fill="none"
                            className={`-mt-1 group-hover:text-primary/90 transition-colors ${isDarkMode ? 'text-white/70' : 'text-gray-500'}`}
                        >
                        ...
                        <motion.svg
                            ...
                            width="24" height="12" viewBox="0 0 24 12" fill="none"
                            className={`-mt-1 group-hover:text-primary transition-colors ${isDarkMode ? 'text-white' : 'text-gray-700'}`}
                        >
