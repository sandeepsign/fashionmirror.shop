...
export default function WidgetEmbed() {
    ...
    useEffect(() => {
        ...
        // Apply theme
        const effectiveTheme = sessionData.theme === "auto"
    ...
    if (!session && step !== "error") {
        return (<div className="widget-embed widget-loading">
        <Loader2 className="animate-spin" size={32}/>
        <p>Loading...</p>
      </div>);
    }
    return (<div className="widget-embed" data-step={step}>
      {/* Photo Selection Step */}
      {step === "photo" && (<div className="widget-step photo-step">
          <div className="step-header">
            <h2>Upload Your Photo</h2>
            <p>Take a photo or upload one to see how this item looks on you</p>
          </div>

          {showCamera ? (<div className="camera-view">
            ...
            </div>) : (<div className="photo-options">
              {session?.allowCamera && (<button onClick={startCamera} className="photo-option">
                  <Camera size={32}/>
                  <span>Take a Photo</span>
                </button>)}

              {session?.allowUpload && (<button onClick={() => fileInputRef.current?.click()} className="photo-option">
                  <Upload size={32}/>
      ...
      {/* Preview Step */}
      {step === "preview" && userPhoto && (<div className="widget-step preview-step">
          <div className="step-header">
            <h2>Looking Good!</h2>
      ...
      {/* Processing Step */}
      {step === "processing" && (<div className="widget-step processing-step">
          <div className="processing-animation">
            <div className="processing-ring" style={{ '--progress': `${progress}%` }}/>
      ...
      {/* Result Step */}
      {step === "result" && result && (<div className="widget-step result-step">
          ...
          <div className="result-info">
            ...
            {session?.product.price && (<p className="price">{formatPrice(session.product.price, session.product.currency)}</p>)}
          </div>
          ...
          <div className="result-actions">
            ...
            {session?.product.url && (<button onClick={handleBuy} className="btn btn-primary btn-buy">
      ...
      {/* Error Step */}
      {step === "error" && error && (<div className="widget-step error-step">
