...
>
  ...
  data-product-description="A beautiful summer dress perfect for any occasion. Features a flattering A-line silhouette."
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr className="bg-white">
                    ...
                    <td className="px-4 py-3"><span className="text-gray-400">No</span></td>
                    <td className="px-4 py-3 text-gray-600">Product specs (e.g., "100% Cotton, Machine Washable")</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="px-4 py-3 font-mono text-sm text-gray-900">data-product-description</td>
                    <td className="px-4 py-3"><span className="text-gray-400">No</span></td>
                    <td className="px-4 py-3 text-gray-600">Long-form product description shown on result</td>
                  </tr>
                  <tr className="bg-white">
