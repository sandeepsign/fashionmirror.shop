        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://github.com/fashionmirror"
                target="_blank"
                ...
                <div key={idx}>
                  ...
                  <ul className="space-y-2">
                    {section.items.map((item, itemIdx) => (
                      <li key={itemIdx}>
                        <Link href={item.href}>
                          <span className={`block px-3 py-2 rounded-lg text-sm transition-colors ${
                            location === item.href
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {[
                  ...
                  <Link key={idx} href={card.href}>
                    <motion.div
                      whileHover={{ y: -4 }}
                      className="bg-white p-6 rounded-xl border border-gray-200 hover:border-primary/30 hover:shadow-lg transition-all cursor-pointer h-full"
                    >
