...
import { Loader2, TrendingUp, CheckCircle, Clock, ArrowRight, Copy, Check } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent>
                <div className="flex items-center gap-2 p-3 bg-slate-900 rounded-lg border border-slate-700">
                  ...
                  <Button variant="ghost" size="sm" onClick={copyApiKey} className="text-slate-400 hover:text-white">
                    {copied ? (<Check className="h-4 w-4 text-green-400"/>) : (<Copy className="h-4 w-4"/>)}
                  </Button>
                </div>
                <Button className="w-full mt-4 bg-indigo-600 hover:bg-indigo-700" onClick={() => setLocation('/merchant/integration')}>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent>
                ...
                <Button variant="outline" className="w-full mt-4 border-slate-600 text-slate-300 hover:bg-slate-700 hover:text-white" onClick={() => setLocation('/merchant/integration')}>
